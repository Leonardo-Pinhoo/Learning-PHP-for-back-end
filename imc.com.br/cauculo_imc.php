...
?>    
    <p><img src="https://veja.abril.com.br/wp-content/uploads/2024/10/arte-IMC-digital-2917.jpg?crop=1&resize=1212,909" alt="Tabela dos valores de imc" width="350" height="450"></p>
<?php
    if($imc < 18.5){
        echo "<p> <h2>De acordo com o seu imc de ". round($imc, 2). " você está abaixo do peso </h2></p>";
